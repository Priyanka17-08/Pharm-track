...
| :---: | :---: | 
| <img src="https://via.placeholder.com/600x350.png?text=Dashboard+Screenshot" alt="Dashboard View" width="100%" /> | <img src="https://via.placeholder.com/600x350.png?text=Settings+Screenshot" alt="Settings View" width="100%" /> |
